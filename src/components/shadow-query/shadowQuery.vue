<template>
  <div id="shadowquery-panel" class="sm-panel">
    <!-- <div class="sm-function-module-sub-section" style="margin: 0">
      <div class="sm-half-L">
      ...
      <div class="boxchild flex-between" style="padding: 0">
        ...
        <div class="flex flex-end" style="width: auto">
          <button @click="analysis" class="tbtn tbtn-width" type="button" style>
            {{ Resource.analyze }}
          </button>
          <button
            @click="clear"
